      ...
      <Table className="rounded-xl border relative border-richblack-800">
        <Thead>
          <Tr className="flex md:gap-x-10 md:w-full rounded-t-md border-b border-b-richblack-800 md:px-6 py-2">
            ...
            <Th className="flex text-left text-sm font-medium uppercase text-richblack-800 mr-[670px]">
              Courses
            </Th>
            </div>
            ...
            <Th className=" text-sm font-medium uppercase text-richblack-800 ml-[720px]">
              Price
            </Th>
